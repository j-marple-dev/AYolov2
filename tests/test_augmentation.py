...
def test_uniform_augment(show_gui: bool = False, p: float = 0.5):
    ...
    with open(os.path.join("tests", "res", "configs", "train_config_uniaug.yaml")) as f:
        cfg = yaml.safe_load(f)

    aug_policy = MultiAugPoliciesWithUniformAugment(
...
if __name__ == "__main__":
    ...
    test_uniform_augment(show_gui=False)
